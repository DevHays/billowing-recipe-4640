...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/imagegen
```

A live public deployment of this template is available at [https://imagegen.templates.workers.dev](https://imagegen.templates.workers.dev)
